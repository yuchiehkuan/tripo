...
let FirendListDialogComponent = class FirendListDialogComponent {
    constructor(dialogRef, fb, data) {
        this.dialogRef = dialogRef;
        this.fb = fb;
        this.data = data;
...
FirendListDialogComponent.ctorParameters = () => [
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatDialogRef"] },
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
    { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material__WEBPACK_IMPORTED_MODULE_3__["MAT_DIALOG_DATA"],] }] }
];
...
let NoteComponent = class NoteComponent {
    constructor(fb, userService, dialog, bottomSheet, travel) {
        this.fb = fb;
        this.userService = userService;
        this.dialog = dialog;
...
let NavbarComComponent = class NavbarComComponent {
    constructor(dialog) {
        this.dialog = dialog;
    }
    ngOnInit() {
    ...
    friendListDialog() {
        const dialogRef = this.dialog.open(_communication_firend_list_dialog_firend_list_dialog_component__WEBPACK_IMPORTED_MODULE_3__["FirendListDialogComponent"], {
            width: '700px',
            data: {}
        });
        dialogRef.afterClosed().subscribe(res => {
...
NavbarComComponent.ctorParameters = () => [
...
let NavbarComModule = class NavbarComModule {
};
...
let NavbarComponent = class NavbarComponent {
    constructor(userService, router, nav, not, breakpointObserver, snackbar) {
        this.userService = userService;
        this.router = router;
        this.nav = nav;
        this.not = not;
    ...
    ngOnInit() {
        this.isHandset$ = this.breakpointObserver.observe([_angular_cdk_layout__WEBPACK_IMPORTED_MODULE_6__["Breakpoints"].Handset, _angular_cdk_layout__WEBPACK_IMPORTED_MODULE_6__["Breakpoints"].Tablet]).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["map"])(match => match.matches));
        // this.login$ = Observable.of(true);
        this.login$ = this.userService.getLoginStatus();
        this.user$ = this.userService.getCurrentUser();
        this.getNoticeList();
...
let NoticeService = class NoticeService {
    ...
    getNoticeList() {
        this.getNoticeListServer().subscribe(data => this.noticeList.push(data)); // test
        const noticeList = Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(NoticeLists);
        return noticeList;
    }
    removeNoticeServer(id) {
    ...
    removeNotice(id) {
        return this.removeNoticeServer(id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((res) => {
            if (res) {
                if (res) {
...
let PersonalComponent = class PersonalComponent {
    ...
    constructor(dialog, route, nav, userService, router, snackbar) {
        this.dialog = dialog;
        this.route = route;
        this.nav = nav;
        this.userService = userService;
    ...
    avatarDialog() {
        ...
        dialogRef.afterClosed().subscribe(res => {
            if (res) {
                ...
                console.log(res[0]);
                this.userService.updateUserAva(res[0])
                    .subscribe(res2 => {
                    if (res2) {
                        this.snackbar.open('修改成功', 'OK', { duration: 3000 });
...
let MapNavComponent = class MapNavComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let ScheduleDetailComponent = class ScheduleDetailComponent {
    ...
    addScheduleDialog() {
        ...
        const dialogRef = this.dialog.open(_add_schedule_dialog_add_schedule_dialog_component__WEBPACK_IMPORTED_MODULE_7__["AddScheduleDialogComponent"], {
            width: '600px',
            // height: '700px',
            data: {
    ...
    shareDialog() {
        const dialogRef = this.dialog.open(_share_edit_dialog_share_edit_dialog_component__WEBPACK_IMPORTED_MODULE_1__["ShareEditDialogComponent"], {
            width: '600px',
            // height: '700px',
            data: {}
        });
...
let ShareEditDialogComponent = class ShareEditDialogComponent {
    constructor(dialogRef, fb, data) {
        this.dialogRef = dialogRef;
        this.fb = fb;
        this.data = data;
...
ShareEditDialogComponent.ctorParameters = () => [
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatDialogRef"] },
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
    { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material__WEBPACK_IMPORTED_MODULE_3__["MAT_DIALOG_DATA"],] }] }
];
...
let UserService = class UserService {
    constructor(http, appConfig, utils, travel, notice) {
        this.http = http;
        this.appConfig = appConfig;
        this.utils = utils;
        this.travel = travel;
    ...
    register(registerData) {
        return this.registerServer(registerData).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])((res) => {
            if (res) {
    ...
    login(loginData) {
        return this.loginServer(loginData).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])((res) => {
            if (res) {
                if (!res.error) {
                    ...
                    this.notice.setToken(this.token[0].access_token);
    ...
    getMembers() {
        ...
        const members = Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["of"])(Members);
        return members;
    }
    getUserInfo() {
        this.getUserFromServer().subscribe(data => this.userInfo.push(data.user_info)); // test
        const userInfo = Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["of"])(UserInfos);
        return userInfo;
    }
    // getMemberInfo() {
    //   this.member = [];
    ...
    getUserPrivacy() {
        ...
        const privacy = Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["of"])(Privacys);
        return privacy;
    }
    getUserNoticeServer() {
        const token = this.token[0].access_token;
    ...
    updateUserInfo(newData) {
        return this.updateUserInfoServer(newData).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])((res) => {
            if (res) {
                if (!res.error) {
                    this.member = []; // test
                    this.userInfo = []; // test
    ...
    updateUserAva(newData) {
        return this.updateUserAvaServer(newData).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])((res) => {
            if (res) {
                if (!res.error) {
                    this.member = []; // test
                    this.userInfo = []; // test
    ...
    updateUserPwd(newData) {
        return this.updateUserPwdServer(newData).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])((res) => {
            if (res) {
                if (!res.error) {
                    // this.getUser();
                    return true;
    ...
    updateUserPrivacy(newData) {
        return this.updateUserPrivacyServer(newData).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])((res) => {
            if (res) {
                if (!res.error) {
                    return true;
                }
